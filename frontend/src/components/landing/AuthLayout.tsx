...
export function AuthLayout({ title, subtitle, children }: AuthLayoutProps) {
  return (
    <div className="min-h-screen overflow-hidden bg-surface-dark text-ink-primary">
      <div className="mx-auto flex min-h-screen flex-col md:flex-row">
        {/* Form side */}
        <div className="flex flex-1 flex-col justify-between border-b border-white/5 bg-surface-dark/95 px-6 py-5 md:border-b-0 md:border-r md:border-white/5">
